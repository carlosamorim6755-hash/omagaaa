...
local Window = OrionLib:MakeWindow({Name = "DarkAngel Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "DarkAngel Hub"})
...
W:AddLabel("[+] DarkAngel Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "DarkAngel Hub(Noitification)",
